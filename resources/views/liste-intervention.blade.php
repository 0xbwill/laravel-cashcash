<x-app-layout>
    ...
    <div class="py-12">
        <div class="container-fluid sm:px-6 lg:px-8">
            @if (session('success'))
            ...
            <div class="overflow-hidden sm:rounded-lg text-white">
                ...
                <div class="d-flex">
                    <form action="{{ route('interventions.filter.date') }}" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-primary ml-4 mb-4" data-toggle="button" aria-pressed="false"
                            autocomplete="off">
                            Trier par date
                        </button>
                    </form>
                ...
                <div class="d-flex flex-wrap">
                    ...
                    @foreach ($mesInterventions as $uneIntervention)
                        <div class="card col-xl-3 text-white mb-3 rounded-lg mx-3"
                            style="max-width: 18rem;background-color:#0e131c;border:2px #282f3d solid">
